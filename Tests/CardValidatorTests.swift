...
fileprivate struct TestsCardNumbers {
    static let validCards = [
        ...
        BankCard("4916","6512","3456","7894"),
        BankCard("5404","1234","5678","9016"),
        BankCard("5296","7890","1234","5674"),
        BankCard("5222","8765","4321","0987"),
        BankCard("4485","1234","5678","9102"),
        BankCard("4556","2345","6789","0327"),
        BankCard("5156","2345","6789","1235"),
        BankCard("2223","4567","8901","2342")
    ]
    ...
    static let invalidCard = [
        ...
        BankCard("9999","0001","8888","1111"),
        BankCard("5432","1234","5678","9013"),
        BankCard("0001","0100","1000","0100")
    ]
    
    static let negative = [
        BankCard("-234","5678","9101","1121"),
        BankCard("-234","-678","9101","1121"),
        BankCard("-234","5678","-101","1121"),
        BankCard("-234","5678","9101","-121"),
    ]
